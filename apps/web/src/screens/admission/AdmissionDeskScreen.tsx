                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold ${
                          item.status === 'REQUESTED' ? 'bg-amber-50 text-amber-700 border border-amber-200' :
                          item.status === 'ELIGIBILITY_CHECKED' ? 'bg-blue-50 text-blue-700 border border-blue-200' :
                      ...
                      <div className="text-xs text-gray-500 flex flex-wrap gap-x-4 gap-y-1 pt-1">
                        <span>Department: <strong className="text-gray-700">{item.visit.employee.department}</strong></span>
                        <span>Post: <strong className="text-gray-700">{item.visit.employee.post.title} ({item.visit.employee.grade.payLevel})</strong></span>
                        <span>Ward Category: <strong className="text-esic-primary font-semibold">GENERAL WARD</strong></span>
                      </div>
                    </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-xl space-y-6">
            <div className="flex justify-between items-start border-b border-gray-100 pb-4">
              ...
              <button onClick={() => setSelectedAdmission(null)} className="text-gray-400 hover:text-gray-600">
