...
const DEV_MEMORY_USERS: Record<string, any> = {
  ...
  'doctor@esic.gov.in': {
    ...
    role: {
      ...
      permissions: [
        ...
        { id: 'p2', resource: 'Prescription', action: 'create' },
        { id: 'p3', resource: 'Prescription', action: 'update' },
        { id: 'p4', resource: 'Prescription', action: 'sign' },
      ],
    },
  },
  'reception@esic.gov.in': {
    ...
    role: {
      ...
      isSystemRole: true,
      permissions: [
        { id: 'p2', resource: 'Employee', action: 'create' },
        { id: 'p3', resource: 'Employee', action: 'read' },
        { id: 'p4', resource: 'HospitalUID', action: 'read' },
      ],
    },
  },
};
